...
public class addInstructor {
    ...
    public void handle(User user) throws SQLException {
        ...
        getDepartmentIdByName departmentId = new getDepartmentIdByName();
        departmentId.handle(user.getDepartments().getName());


        String sql = "INSERT INTO users (first_name, last_name, email, password, role_id, dept_id) " +
                     "VALUES (?,?,?,?,?,?)";
        ...
        ps.setInt(6, departmentId.getId()); 
